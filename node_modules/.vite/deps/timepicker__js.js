...
// node_modules/timepicker.js/dist/timepicker.js
var require_timepicker = __commonJS({
  "node_modules/timepicker.js/dist/timepicker.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.TimePicker = factory());
    })(exports, function() {
      "use strict";
      var EVENT_TYPE = {
        open: "open",
      ...
      function fade(ref) {
        ...
        var start = null;
        var requestId;
        var ref$1 = action === "in" ? [EVENT_TYPE.startFadeIn, EVENT_TYPE.endFadeIn] : [EVENT_TYPE.startFadeOut, EVENT_TYPE.endFadeOut];
        ...
        var tick = function(timestamp) {
          ...
          var opacity = action === "in" ? Number(element.style.opacity) + (timestamp - start) / time : Number(element.style.opacity) - (timestamp - start) / time;
      ...
      function addClass(element, classname) {
        if (Array.isArray(element)) {
          element.forEach(function(each) {
            return addClass(each, classname);
          });
          return;
        }
      ...
      function removeClass(element, classname) {
        if (Array.isArray(element) || NodeList.prototype.isPrototypeOf(element)) {
          element.forEach(function(each) {
            return removeClass(each, classname);
          });
          return;
        }
        var array = Array.isArray(classname) ? classname : classname.split(/[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+/);
      ...
      function hasClass(element, classname) {
        return element.classList ? element.classList.contains(classname) : classRegex(classname).test(element.className);
      }
      ...
      function createElement(node, html) {
        ...
        if (Array.isArray(node)) {
          ...
          if (node[1].id) {
            element.id = node[1].id;
          }
          if (node[1].classname) {
            element.className = node[1].classname;
          }
          if (node[1].attr) {
            var ref = node[1];
            var attr = ref.attr;
        ...
        while (element.childNodes[0]) {
          frag.append(element.childNodes[0]);
        }
        element.append(frag);
        return element;
      }
      ...
      function getMaxZIndex() {
        return Array.from(
          ...
          function(el) {
            return Number.parseFloat(window.getComputedStyle(el).zIndex);
          }
      ...
      function createStructure(picker) {
        ...
        var container = createElement(["div", { classname }], structure.join(""));
      ...
      function handleDrag(picker) {
        ...
        var dragging = function(evt) {
          ...
          when.move.call(void 0, { target: element, x, y });
          lastX = evt.clientX;
          lastY = evt.clientY;
        };
        var stopDragging = function() {
          ...
          when.end.call(void 0, { target: element, x, y });
        };
      ...
      function base(target, initOptions) {
        ...
        function initialize() {
          ...
          drag.when({
            start: function() {
              return addClass(container, style.dragging);
            },
            move: function(resp) {
        ...
        function show() {
          ...
          var ref = doesNotFitToTheRight ? [windowSize.width - (containerSize.width + 20) + "px", targetOffset.bottom + 5 + "px"] : [targetOffset.right + 5 + "px", targetOffset.top + "px"];
          var left = ref[0];
          var top = ref[1];
          ...
          document.addEventListener(
            "mousedown",
            {
              handleEvent: function handleEvent(evt) {
                if (containerElement.contains(evt.target)) {
                  return;
                }
...
export default require_timepicker();
/*! Bundled license information:

timepicker.js/dist/timepicker.js:
  (*!
  * timepicker.js - v3.1.0
  * Built: Mon Feb 22 2021 10:34:56 GMT-0300 (Brasilia Standard Time)
  *)
*/
//# sourceMappingURL=timepicker__js.js.map
